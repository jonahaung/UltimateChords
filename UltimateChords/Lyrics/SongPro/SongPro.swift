...
public struct SongPro {
    ...
    fileprivate static func processSection(text: String, song: inout Song) -> SongSection {
        var key: String?
    ...
    fileprivate static func processLyricsAndChords(text: String, song: inout Song, currentSection: inout SongSection?) {
        if text.isEmpty {
            return
        }
