...
//  UltimateChords
//
//  Created by Aung Ko Min on 29/3/22.
//
...
open class DPTagTextView: UITextView {
    ...
    open var textViewAttributes: [NSAttributedString.Key: Any] = {[.foregroundColor: UIColor.label, .font: XFont.body(for: "")]}()

    open var mentionTagTextAttributes: [NSAttributedString.Key: Any] = {
        [.foregroundColor: UIColor.link, .font: XFont.chord(), .baselineOffset: 10]
    }()
    
    open var hashTagTextAttributes: [NSAttributedString.Key: Any] = {
        [.foregroundColor: UIColor.systemPink, .font: XFont.chord()]
    }()
...
public extension DPTagTextView {
    ...
    func addTag(allText: String? = nil, tagText: String, id: String = UUID().uuidString, data : [String:Any] = [:], customTextAttributes: [NSAttributedString.Key: Any]? = nil , isAppendSpace: Bool = false) {
